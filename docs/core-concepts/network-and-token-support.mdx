...
x402 supports tokens on EVM, Solana, TON, Stellar, Aptos, Hedera, and Keeta networks:
...
* **Any EVM chain** is supported via `eip155:<chainId>` — plus Solana, TON (TVM), Algorand, Stellar, Aptos, Hedera, and Keeta
